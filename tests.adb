--  Standalone test suite for Postman_Sort (main program).
...
begin
   ...
   begin
      ...
      Check (Is_Sorted (A), "classic multi-digit Is_Sorted");
   end;
   ...
   ---------------------------------------------------------------------
   Section ("6. Sort_Base with radix 2, 10, 16, 256");
   ---------------------------------------------------------------------
   declare
